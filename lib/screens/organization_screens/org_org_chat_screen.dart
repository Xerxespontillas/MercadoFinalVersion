...
class OrgToOrgChatArguments {
  final String userId;
  final OrgToOrgType userType;
  final String displayName;
  final String orgId;

  OrgToOrgChatArguments({
...
class OrgToOrgChatScreen extends StatefulWidget {
  static const routeName = '/org-org-chat-screen';
  ...
  @override
  _OrgToOrgChatScreenState createState() => _OrgToOrgChatScreenState();
}

class _OrgToOrgChatScreenState extends State<OrgToOrgChatScreen> {
  ...
  void initState() {
    ...
    _chatStream = _firestore
        ...
        .where('orgId', isEqualTo: widget.customerId)
        .orderBy('createdAt', descending: true)
        .snapshots();
  }

  String getChatCollection() {
    return widget.userType == OrgToOrgType.organization
        ? 'organization'
        : 'customer';
  }
