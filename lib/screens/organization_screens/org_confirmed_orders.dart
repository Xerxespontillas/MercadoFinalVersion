...
import 'package:merkado/screens/organization_screens/org_selected_confirmed_order.dart';


class OrgCustomerConfirmedOrders extends StatefulWidget {
  const OrgCustomerConfirmedOrders({super.key});

  @override
  State<OrgCustomerConfirmedOrders> createState() =>
      _OrgCustomerConfirmedOrdersState();
}

class _OrgCustomerConfirmedOrdersState
    extends State<OrgCustomerConfirmedOrders> {
  @override
                ...
                onTap: () {
                  if (order.data() is Map) {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => OrgMySelectedConfirmOrder(
