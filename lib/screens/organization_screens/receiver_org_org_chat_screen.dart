...
class ReceiverOrgToOrgChatArguments {
  final String userId;
  final ReceiverOrgToOrgType userType;
  final String displayName;
  final String orgId;

  ReceiverOrgToOrgChatArguments({
...
enum ReceiverOrgToOrgType {
  customers,
  farmer,
  organization,
}

class ReceiverOrgToOrgChatScreen extends StatefulWidget {
  static const routeName = '/receiver-org-org-chat-screen';
  ...
  const ReceiverOrgToOrgChatScreen({
    required this.userId,
    required this.userType,
  ...
  _ReceiverOrgToOrgChatScreenState createState() =>
      _ReceiverOrgToOrgChatScreenState();
}

class _ReceiverOrgToOrgChatScreenState
    extends State<ReceiverOrgToOrgChatScreen> {
  ...
  String getChatCollection() {
    return widget.userType == ReceiverOrgToOrgType.organization
        ? 'organization'
        : 'customer';
  }
