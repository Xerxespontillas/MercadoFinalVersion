...
class OrgToFarmerChatArguments {
  final String userId;
  final OrgToFarmerType userType;
  final String displayName;
  final String farmerId;

  OrgToFarmerChatArguments({
...
enum OrgToFarmerType {
  customers,
  farmer,
  organization,
}

class OrgToFarmerChatScreen extends StatefulWidget {
  static const routeName = '/org-farmer-chat-screen';
  ...
  @override
  _OrgToFarmerChatScreenState createState() => _OrgToFarmerChatScreenState();
}

class _OrgToFarmerChatScreenState extends State<OrgToFarmerChatScreen> {
  ...
  String getChatCollection() {
    return widget.userType == OrgToFarmerType.organization
        ? 'organization'
        : 'customer';
  }
