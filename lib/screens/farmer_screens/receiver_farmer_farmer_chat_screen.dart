...
class ReceiverFarmersChatArguments {
  final String userId;
  final ReceiverFarmersType userType;
  final String displayName;
  final String farmerId;

  ReceiverFarmersChatArguments({
...
enum ReceiverFarmersType {
  customers,
  farmer,
  organization,
}

class ReceiverFarmerToFarmerChatScreen extends StatefulWidget {
  static const routeName = '/receiver-farmer-farmer-chat-screen';
  ...
  const ReceiverFarmerToFarmerChatScreen({
    required this.userId,
    required this.userType,
  ...
  _ReceiverFarmerToFarmerChatScreenState createState() =>
      _ReceiverFarmerToFarmerChatScreenState();
}

class _ReceiverFarmerToFarmerChatScreenState
    extends State<ReceiverFarmerToFarmerChatScreen> {
  ...
  String getChatCollection() {
    return widget.userType == ReceiverFarmersType.farmer
        ? 'farmer'
        : 'customer';
  }
