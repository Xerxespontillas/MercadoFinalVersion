...
class FarmersChatArguments {
  final String userId;
  final FarmersType userType;
  final String displayName;
  final String farmerId;

  FarmersChatArguments({
...
class FarmerToFarmerChatScreen extends StatefulWidget {
  static const routeName = '/farmer-farmer-chat-screen';
  ...
  const FarmerToFarmerChatScreen({
    required this.userId,
    required this.userType,
  ...
  _FarmerToFarmerChatScreenState createState() =>
      _FarmerToFarmerChatScreenState();
}

class _FarmerToFarmerChatScreenState extends State<FarmerToFarmerChatScreen> {
  ...
  void initState() {
    ...
    _chatStream = _firestore
        ...
        .where('farmerId', isEqualTo: widget.customerId)
        .orderBy('createdAt', descending: true)
        .snapshots();
  }

  String getChatCollection() {
    return widget.userType == FarmersType.farmer ? 'farmer' : 'customer';
  }
