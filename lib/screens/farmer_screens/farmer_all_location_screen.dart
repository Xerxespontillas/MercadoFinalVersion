...
class FarmerAllLocationScreen extends StatefulWidget {
  static const routeName = '/farmer-all-location';

  const FarmerAllLocationScreen({super.key});

  @override
  FarmerAllLocationScreenState createState() => FarmerAllLocationScreenState();
}

class FarmerAllLocationScreenState extends State<FarmerAllLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Farmer All Location')),
      body: GoogleMap(
