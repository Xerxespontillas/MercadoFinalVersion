...
class FarmerCompletedCustomersOrders extends StatefulWidget {
  const FarmerCompletedCustomersOrders({super.key});

  @override
  State<FarmerCompletedCustomersOrders> createState() =>
      _FarmerCompletedCustomersOrdersState();
}

class _FarmerCompletedCustomersOrdersState
    extends State<FarmerCompletedCustomersOrders> {
