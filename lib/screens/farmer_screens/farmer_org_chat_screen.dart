...
class FarmerToOrgChatArguments {
  final String userId;
  final FarmerToOrgType userType;
  final String displayName;
  final String orgId;

  FarmerToOrgChatArguments({
...
enum FarmerToOrgType {
  customers,
  farmer,
  organization,
}

class FarmerToOrgChatScreen extends StatefulWidget {
  static const routeName = '/farmer-org-chat-screen';
  ...
  @override
  _FarmerToOrgChatScreenState createState() => _FarmerToOrgChatScreenState();
}

class _FarmerToOrgChatScreenState extends State<FarmerToOrgChatScreen> {
  ...
  String getChatCollection() {
    return widget.userType == FarmerToOrgType.farmer ? 'farmer' : 'customer';
  }
